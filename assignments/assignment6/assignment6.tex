...
\title{COMPSCI 590N: Assignment 6}
\date{Due: October 23, 2017 at 11:55pm}
...
\maketitle
Please modify \verb|testing.py| as instructed and submit a \textbf{zip} file containing your your modified version of \verb|testing.py| as well as a \textbf{PDF} containing all responses to Problem 1.

\section*{Problem 1: Debugging}
The file \verb|debugging.py| contains code that searches a piece of text for all instances of a search string. Please use \verb|pdb| to answer the following questions with modifying \verb|debugging.py|. 

\begin{enumerate}
	\item What are the names of the local variables defined at line 16? (hint: use dir())
	\item What is the value of the variable \verb|pattern_length| at line 16?
	\item What is the value of the variable \verb|search_index| the first time line 23 is executed?
	\item What is the value of the variable \verb|text_index| the second time line 23 is executed?
	\item What is the value and type of the variable \verb|offests| at line 29 when the variable \verb|text_index| has the value 377?
\end{enumerate}

\section*{Problem 2: Testing and Documentation}
The file \verb|testing.py| contains a function called \verb|merge_sort| that takes a list of numbers and returns a sorted list. Please use the \verb|unittest| module to add two separate tests for this sorting algorithm. You may choose any input/output pairs to test and may use any of the custom assertions to test the outputs from \verb|merge_sort|.

Once you have written the two test functions. Please describe each test function in an associated \verb|docstring|. For example, if you were to call your Test Case class \verb|MergeSortTester| and name one of the test functions \verb|test1|, running

\begin{verbatim}
	>>> from testing import *
	>>> help(MergeSortTester.test1)
\end{verbatim}

should print a description of the test in \verb|test1|.
